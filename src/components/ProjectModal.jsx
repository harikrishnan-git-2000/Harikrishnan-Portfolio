...
const ProjectModal = ({ project, onClose }) => {
    ...
    const renderDetailContent = (detail, index) => {
        ...
        switch (detail.type.toLowerCase()) {
            ...
            case 'buttonlink': return (<div key={index} className="my-4"> <a href={detail.href} target="_blank" rel="noopener noreferrer" className="text-white accent-white hover:bg-white-50 focus:ring-4 focus:ring-blue-300 rounded-sm text-sm px-4 py-2 transition">{detail.label || 'Link'}</a></div>);
